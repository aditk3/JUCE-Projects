...
struct MainApplication::MainMenuBarModel : public MenuBarModel {
    ...
    MainMenuBarModel() { setApplicationCommandManagerToWatch(&getApp().commandManager); }

    /// This method returns a juce::StringArray containing all the menubar's menu names.
    /// Our app has a single menu, called "Texts".
    StringArray getMenuBarNames() override { return {"Texts"}; }
...
void MainApplication::getAllCommands(juce::Array<juce::CommandID>& commands) {
    const CommandID ids[] = {LATIN_TEXT, GREEK_TEXT, CYRILLIC_TEXT};
...
MenuBarModel* MainApplication::getMenuBarModel() { return mainMenuBarModel.get(); }
...
const String MainApplication::getApplicationName() { return "GUI Basics"; }

const String MainApplication::getApplicationVersion() { return ""; }
