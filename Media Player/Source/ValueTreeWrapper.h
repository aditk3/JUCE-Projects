...
struct ValueTreeWrapper {
    ...
    /// add a listener
    void addListener(juce::ValueTree::Listener* listener) { data.addListener(listener); }
    /// remove a listener
    void removeListener(juce::ValueTree::Listener* listener) { data.removeListener(listener); }
    /// conversion operator
    operator juce::ValueTree() { return data; }
    /// conversion operator
