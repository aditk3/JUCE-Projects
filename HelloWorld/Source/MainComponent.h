...
class MainComponent : public juce::Component {
   ...
   private:
    ...
    juce::String greetings[6]{"Hello, world!", "Hallo, wereld!", "Bonjour, monde!",
                              "Hallo, Welt!",  "Ciao, mondo!",   "Hola, mundo!"};

    juce::String curGreeting = greetings[0];

    // First 3 are dark, last are light
    juce::Colour colours[6]{getLookAndFeel().findColour(juce::ResizableWindow::backgroundColourId),
