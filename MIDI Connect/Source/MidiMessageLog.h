...
struct MidiMessageLog : public ListBox, private ListBoxModel, private AsyncUpdater {
    ...
    /// pixels in from the left margin and using Justification::centredLeft.
    /// See Graphics::drawText().
    /// Note: From the perspective of this function the graphics context has already
    /// focused the repaint region to be the area of the row to paint. This means your
    /// code should draw text using _local_ bounds: 0 0 width height.
